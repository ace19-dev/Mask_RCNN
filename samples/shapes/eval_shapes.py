...
dataset_eval.load_shapes(50, inference_config.IMAGE_SHAPE[0], inference_config.IMAGE_SHAPE[1])
...
image_id = random.choice(dataset_eval.image_ids)
...
image_ids = np.random.choice(dataset_eval.image_ids, 10)
APs = []
